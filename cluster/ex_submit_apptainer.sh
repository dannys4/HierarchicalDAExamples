...
export APPTAINERENV_RUN_CMD=./cluster/run_example

singularity exec -f -H /home/jovyan --no-home --writable-tmpfs --bind .:/home/jovyan/cluster,$OUT_DATA_PATH:$IN_DATA_PATH docker://dannys4/hierarchical_data_assimilation ./cluster/ex_command.sh
